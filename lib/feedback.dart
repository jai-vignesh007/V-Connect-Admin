...
import 'package:nssadmin/feedbackview.dart';
import 'eventsview.dart';

class Feedback_ extends StatefulWidget {
  const Feedback_({Key? key}) : super(key: key);

  @override
  State<Feedback_> createState() => _FeedbackState();
}

class _FeedbackState extends State<Feedback_> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context) => FeedView(id: i)));
                          },
